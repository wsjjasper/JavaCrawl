...
LangChain Documentation: LangChain Embeddings

FAISS Documentation: FAISS Wiki

OpenAI Embeddings Guide: OpenAI Embeddings

SQL Parsing Libraries:

sqlparse
PyParsing (for more complex parsing)
